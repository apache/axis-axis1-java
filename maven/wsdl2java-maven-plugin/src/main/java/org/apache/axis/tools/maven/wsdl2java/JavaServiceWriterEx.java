...
public class JavaServiceWriterEx extends JavaServiceWriter {
    ...
    protected void setGenerators() {
        ...
        if (sEntry.isReferenced()) {
            serviceIfaceWriter = new JavaServiceIfaceWriterEx(emitter, sEntry, symbolTable);
            serviceImplWriter = new JavaServiceImplWriterEx(emitter, sEntry, symbolTable);
            if (emitter.isTestCaseWanted()) {
                testCaseWriter = new JavaTestCaseWriterEx(emitter, sEntry, symbolTable);
            }
        }
    }
}
