...
public class TypeTestServiceTestCase extends junit.framework.TestCase {
    ...
    */
    ...
    public void test29TypeTestElemWComplexInout() throws Exception {
        ...
        // Test operation
        binding.elemWComplexInout(new test.wsdl.types.comprehensive_types.holders._elemWComplexHolder(new test.wsdl.types.comprehensive_types._elemWComplex()));
        // TBD - validate results
    }
    ...
    public void test74TypeTestMethodSimpleAnyURI() throws Exception {
        ...
        // Test operation
        test.wsdl.types.comprehensive_types2.SimpleAnyURIType value = null;
        value = binding.methodSimpleAnyURI(new test.wsdl.types.comprehensive_types2.SimpleAnyURIType(), new test.wsdl.types.comprehensive_types2.holders.SimpleAnyURITypeHolder(new test.wsdl.types.comprehensive_types2.SimpleAnyURIType()));
        // TBD - validate results
    }
